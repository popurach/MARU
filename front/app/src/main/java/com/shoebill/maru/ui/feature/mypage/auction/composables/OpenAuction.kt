...
import com.shoebill.maru.ui.feature.mypage.auction.MyBiddingViewModel
...
fun OpenAuction(
    ...
    val landmarkInfos = myBiddingViewModel.getMyNonBiddingPagination(navigateViewModel.navigator!!)
